...
<head>
    ...
    <script language="javascript">
        ...
        function getProgress() {
            var loader = new net.AjaxRequest("index4_showProgress.jsp?nocache=" + new Date().getTime(), deal_p, onerror, "GET");
        }
...
<body>
<form name="form1" enctype="multipart/form-data" method="post" action="upFile?action=uploadFile">
    <table width="500" height="289" border="0" align="center" cellpadding="0" cellspacing="0"
                ...
                <table width="80%" height="190" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td height="29" align="center" style="color:#FFFFFF">
                            <div id="progressBar" class="prog_border" align="left"><img src="images/progressBar.jpg"
                                                                                        width="0" height="13"
                                                                                        id="imgProgress"></div>
                            上传进度<span id="progressPercent" style="width:40px;display:none">0%</span></td>
                    </tr>
                    <tr>
                        <td height="29" align="center"><img src="images/shangchuan.gif" width="61" height="23"
                                                            onClick="deal(form1)">
