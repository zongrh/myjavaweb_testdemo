...
<head>
    ...
    <script language="javascript">
        ...
        function checkUser(userName) {
            if (userName.value == "") {
                ...
                createRequest('index1_checkUser.jsp?user=' + userName.value);
            }
        }
    ...
    <style type="text/css">
        ...
        #toolTip {
            ...
            display: none;
            color: red;
            background-image: url(images1/tooltip.jpg);
        }
                ...
                <div style="position:absolute;">
                    ...
                    <table width="100%" height="250" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="33%"><img src="images1/checkBt.jpg" width="104" height="23" style="cursor:hand;"
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td colspan="2"><input type="image" name="imageField" src="images1/registerBt.jpg"></td>
                        </tr>
                    </table>
                </div>
            </td>
