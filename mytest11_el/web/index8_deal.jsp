...
<form name="form1" method="post" action="">
    <table width="400" height="30" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#333333">
        ...
        <tr>
            ...
            <td bgcolor="#FFFFFF">
                &nbsp;${paramValues.affect[0]} ${paramValues.affect[1]} ${paramValues.affect[2]} ${paramValues.affect[3]}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="center" bgcolor="#FFFFFF"><a href="index8.jsp">返回</a></td>
        </tr>
    </table>
</form>
</body>
